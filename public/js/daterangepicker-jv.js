...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        // following two lines added by JVC - 2022-12-06
        this.iconPrevClass = options.iconPrevClass || 'fas fa-chevron-left';
        this.iconNextClass = options.iconNextClass || 'fas fa-chevron-right';
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><i class="'+ this.iconPrevClass+ '"></i></th>';
            } else {this.iconPrevClass
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><i class="'+ this.iconNextClass +'"></i></th>';
            } else {
                html += '<th></th>';
            }
