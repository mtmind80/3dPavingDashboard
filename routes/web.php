...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::group(['prefix' => 'permits'], function() {
        ...
        Route::get('/{proposal_id}/add_permit', 'PermitsController@create')->name('add_permit');
        Route::get('/{permit}/edit', 'PermitsController@edit')->name('permit_edit');
        Route::patch('/{permit_id}', 'PermitsController@update')->name('permit_update');
    ...
    Route::group(['prefix' => 'print'], function() {
        ...
        Route::get('/{id}/permit_invoice', 'PrintingController@permitinvoice')->name('permit_invoice');
