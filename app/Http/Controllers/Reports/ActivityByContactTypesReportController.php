...
use App\Exports\ActivityByContactTypeExport;
...
class ActivityByContactTypesReportController extends Controller
{
    public function index()
    {
        ...
        return view('reports.activity_by_contact_type', $data);
    }
    ...
    public function ajaxView(Request $request)
    {
        if ($request->isMethod('post') && $request->ajax()) {
            ...
            $rows = Proposal::getActivityByContactType($request->from_date, $request->to_date, $request->salesperson_id);
    ...
    public function export(Request $request)
    {
        ...
        if (!empty($rows)) {
            ...
            $reportFileName = 'Activity_by_contact_type' . $request->from_date . '_' . $request->to_date;
            $title = 'Activity Contact Report';

            return Excel::download(new ActivityByContactTypeExport($rows, $request->from_date, $request->to_date, $title), $reportFileName . '.xlsx');
        } else {
