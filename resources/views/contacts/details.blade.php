                    ...
                    <div class="tab-content plr0 pt30 pb0 text-muted">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-6 col-sm-6 mb20">
                                        <div class="form-group select2-wraper">
                                            <form method="POST" action="{{ route('contact_add_staff', ['contact' => $contact->id]) }}" accept-charset="UTF-8" id="addStaffForm" class="admin-form">
                                                @csrf
                                                ...
                                                {{--
                                                <x-href-button id="attach_staff" class="btn-success"><i class="fas fa-plus"></i>@lang('translation.add')</x-href-button>
                                                --}}
                                                <x-button id="attach_staff" type="submit" class="btn-success"><i class="fas fa-plus"></i>@lang('translation.add')</x-button>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 not-lg-hidden mb20"></div>
                                </div>
                        ...
                        @if (!empty($contact->proposals))
                            <div class="tab-pane" id="proposals" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-8 col-sm-6 mb20">
                                        <x-href-button url="{{ route('start_proposal', ['id' => $contact->id, 'returnTo' => Request::url(), 'tab' => 'proposals']) }}" class="btn-success"><i class="fas fa-edit"></i>@lang('translation.newproposal')</x-href-button>
                                    </div>
                                    <div class="col-md-4 col-sm-6 mb20"></div>
                                </div>
