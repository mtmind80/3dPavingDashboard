                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 admin-form-item-widget">
                                <x-form-select name="payment_type" id="payment_type" :items="$payment_types"
                                               :params="['label' => 'Payment Type', 'required' => true]"></x-form-select>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 admin-form-item-widget">
                                <x-form-text id="payment" name="payment" class="check-lead"
                                             :params="['label' => 'Amount', 'iconClass' => 'fas fa-circle', 'required' => true]"></x-form-text>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 admin-form-item-widget">
                                <x-form-text id="check_no" name="check_no" class="check-lead"
                                             :params="['label' => 'Check Number', 'iconClass' => 'fas fa-circle', 'required' => false]"></x-form-text>
                            </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 admin-form-item-widget">
                                    <x-form-textarea id="note" name="note" class="check-lead"
                                             :params="['label' => 'Note', 'iconClass' => 'fas fa-circle', 'required' => false]"></x-form-textarea>
                                </div>
