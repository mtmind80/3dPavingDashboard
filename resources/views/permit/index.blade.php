...
@section('content')
    @component('components.breadcrumb')
        @slot('title') @lang('translation.menu_permits') @endslot
        @slot('li_1') <a href="{{route("dashboard")}}">@lang('translation.Dashboard')</a> @endslot
        @slot('li_2') @lang('translation.menu_permits') @endslot
    @endcomponent
                ...
                <div class="card-body">
                    <div class="row mt5">
                        ...
                        <div class="col-md-4 col-sm-6 mb15">
                            <x-search :needle="$needle" search-route="{{ route('permit_search') }}" cancel-route="{{ route('permits') }}" ></x-search>
                        </div>
                    </div>
                    <table class="list-table table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <th class="sorting_disabled tc w200"> @lang('translation.status') / @lang('translation.expires')</th>
                                                ...
                                                <ul class="dropdown-menu animated animated-short flipInX" role="menu">
                                                    @if ($permit->notes->count())
                                                        <li>
                                                            ...
                                                            >
                                                                <span class="fas fa-comments"></span>@lang('translation.notes')
                                                            </a>
                                                        </li>
                                                    @endif
                                                    <li>
