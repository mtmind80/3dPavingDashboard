...
@section('content')
    @component('components.breadcrumb')
        @slot('title') @lang('translation.materials')@endslot
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('workorder_material_store') }}" accept-charset="UTF-8" id="adminForm" class="admin-form">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 admin-form-item-widget">
                                <x-form-select name="material_id"
                                    :items="$materialsCB"
                                    selected=""
            ...
            @if (!empty($materials))
                <div class="card">
                    <div class="card-body">
                        <h5 class="mb-4">@lang('translation.materials')</h5>
                        <table class="list-table table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @foreach ($materials as $material)
                                    <tr {{ !empty($material->status->color) ? ' style=background-color:#'.$material->status->color.' ' : '' }}data-id="{{ $material->id }}">
                                        ...
                                        <td class="centered">
                                            <form action="{{ route('workorder_material_destroy',['workorder_material_id' => $material->id]) }}" method="post">
                                                @csrf
                        ...
                        <x-paginator
                            ...
                            route-name="workorder_material_list"
                            :params="[
