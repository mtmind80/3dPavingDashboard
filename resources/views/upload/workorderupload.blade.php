...
@section('content')
    @component('components.breadcrumb')
        ...
        @slot('li_2')
            <a href="{{route('show_workorder',['id'=>$proposal_id])}}"> @lang('translation.workorder')</a>
        @endslot
    ...
    <div id="uploadtypes">
        <form id="uploadform" class="custom-validation" novalidate="" action="{{route('doworkorderupload')}}" method="post"
