<!-- Modal -->
<div class="modal fade modal-medium info" id="formManagersModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="formManagersModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content admin-form">
            <form method="POST" action="#" accept-charset="UTF-8" id="admin_form_managers_modal" class="admin-form">
                @csrf
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="formManagersModalLabel"><b><span></span></b> - @lang('translation.assign') @lang('translation.SalesManager')</h5>
                ...
                <div class="modal-body plr10 pt20 pb0">
                    ...
                    <div class="form-group">
                        <select class="form-control" name="assigned_to" id="assigned_to">
                            ...
                            @foreach ($managersCB as $id => $fullName)
