                            ...
                            @if (auth()->user()->role_id <= 4 || auth()->user()->role_id == 7 )
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title mb20">@lang('translation.menu_workorders') @lang('translation.readytotbill')</h4>
                                                <div class="table-responsive">
                                                    <table class="table mb-0">
                                                        ...
                                                        @foreach ($readytobill as $bill)
                                                            <tr>
                                                                <td class="tc">{{ $bill->name ?? null }}</td>
                                                                <td class="tc">{{ $bill->WorkOrderNumber ?? null }}</td>
                                                                <td class="tc">{{ $bill->contact->full_name ?? null }}</td>
                                                                <td class="tc"><a
                                                                            href="{{ route('bill_proposal',['id'=>$bill->id]) }}">Bill
                                                                        Job</a></td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
