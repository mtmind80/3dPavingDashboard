                    ...
                    <form class="custom-validation"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <div>
                                    <input name="cost" id="cost" data-parsley-type="number"
                                           type="text"
                            ...
                            <div class="form-group col-lg-4">
                                <label>@lang('translation.service')</label>
                                <div>
                                    <select name="service_category_id" id="service_category_id" class="form-control">
                                        <option value="{{$records['service_category_id']}}">{{ \App\Models\ServiceCategory::where('id', '=', $records['service_category_id'])->first(['name'])->name}}</option>
