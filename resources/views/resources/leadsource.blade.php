...
@section('content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('new_resource',['model'=>$model]) }}" title="Add Resource"
                       class="btn  btn-success"><i class="fas fa-plus"></i>@lang('translation.create')</a>
                </div>
                <div class="card-body">
                            ...
                            <tr>
                                <td id="tooltip-container8">
                                    ...
                                    <a class="delete" title="Delete"
                                       href="javascript:AREYOUSURE('{{route('destroy_resource', ['model'=>$model,'id'=>$data['id']])}}');">
                                        <i class="mdi mdi-delete-forever font-size-18"></i>
                                    </a> &nbsp;
    ...
    <script type="text/javascript">
            ...
            function AREYOUSURE(url) {
                var ok = confirm("You are about to delete this option permanently. Are you sure?");
                if (ok) {
