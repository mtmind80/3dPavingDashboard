                            ...
                            <div class="col-lg-9">
                                <div>
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted">Reset your password to 3d Paving Dashboard.</p>
                                    </div>
                                    ...
                                    <div class="p-2 mt-5">
                                        ...
                                        <form class="d-inline" method="POST" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group auth-form-group-custom mb-4">
                                                ...
                                                <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" @if(old('email')) value="{{ old('email') }}" @endif  id="username" placeholder="Enter username" autocomplete="email" autofocus placeholder="Enter email">
                                                @error('email')
