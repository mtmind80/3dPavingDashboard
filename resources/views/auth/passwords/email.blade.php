                            ...
                            <div class="col-lg-9">
                                <div>
                                    <div class="text-center">
                                        ...
                                        <p class="text-muted">Reset your password to 3D Paving.</p>
                                    </div>
                                    ...
                                    <div class="p-2 mt-5">
                                        ...
                                        @else
                                            ...
                                            <div class="mt-5 text-center">
                                                <p>© <script>document.write(new Date().getFullYear())</script> 3D Paving . Crafted with <i class="mdi mdi-heart text-danger"></i> by ALLPOINTSWEST Software</p>
                                            </div>
                                        @endif
                                    </div>
                                </div>
