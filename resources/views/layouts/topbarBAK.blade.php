                    ...
                    <div data-simplebar style="max-height: 230px;">
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">@lang('language.your_proposal_is_late')</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">@lang('language.proposal_late')</p>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">{{ Auth::user()->full_name }}</h6>
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">@lang('language.meeting')</p>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h6 class="mt-0 mb-1">@lang('language.proposal_sent')</h6>
                                    <div class="font-size-12 text-muted">
